                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                          ...
                          children: <Widget>[
                             Row(
                              ...
                              children: <Widget>[
                                ...
                                child: Text("Color", style: TextStyle(fontSize: 16, color:  Colors.grey),),),
                              ...
                              child: Row(
                                children: [
                                   SizedBox(
                                    ...
                                    child: Text("Quantity",style:  TextStyle(fontSize: 16, color: Colors.grey),),
                                  ),
                          ...
                          children: List.generate(
                                ...
                                (index) =>  Card(
                                  ...
                                  child: ListTile(title: Text(
                                      itemDetailedButtonList[index], style: TextStyle(fontFamily: semibold,color: darkFontGrey),
                                        ),
                      ...
                      SizedBox(height: 15,),
                      Text(similarProduct, style: TextStyle(fontFamily: bold, fontSize: 16, color: darkFontGrey),)
                    ],
                  ),
                ),
          ),
